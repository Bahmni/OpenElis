...
public class ReferenceDataFeedWorker extends OpenElisEventWorker {
    private HttpClient webClient;
    private String urlPrefix;
    private static Logger logger = Logger.getLogger(ReferenceDataFeedWorker.class);

    public ReferenceDataFeedWorker(HttpClient webClient, String urlPrefix) {
