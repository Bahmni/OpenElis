...
public class ReferenceDataFeedReaderJob extends OpenELISFeedReaderJob {

    private static final String REFERENCE_DATA_WEBCLIENT_CONNECT_TIMEOUT = "reference.data.connectionTimeoutInMilliseconds";
