...
public class AnalysisDAOImplTest {
    ...
    public void getAllByAccessionNumberAndStatus_returns_empty_list_for_null_accession_number() {
        List<Analysis> actualAnalysises = new AnalysisDAOImpl().getAllAnalysisByAccessionNumberAndStatusAndSampleType(null, Arrays.asList(StatusOfSampleUtil.AnalysisStatus.BiologistRejected), "");
    ...
    public void getAllByAccessionNumberAndStatus_returns_empty_list_for_null_status() {
        List<Analysis> actualAnalysises = new AnalysisDAOImpl().getAllAnalysisByAccessionNumberAndStatusAndSampleType("12345", null, "");
    ...
    public void getAllByAccessionNumberAndStatus_returns_empty_list_for_empty_statuses() {
        List<Analysis> actualAnalysises = new AnalysisDAOImpl().getAllAnalysisByAccessionNumberAndStatusAndSampleType("12345", new ArrayList<StatusOfSampleUtil.AnalysisStatus>(), "");
        Assert.assertTrue("should not return analysis for null status", actualAnalysises.isEmpty());
    }
}
