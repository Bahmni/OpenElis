...
SELECT create_relationship_panel_test('APTT','APTT (Control)'); 
SELECT create_relationship_sample_test('Serum','APTT (Control)'); 
SELECT insert_unit_of_measure('sec','APTT (Control)'); 
SELECT create_relationship_test_section_test('Biochemistry','APTT (Control)'); 
...
SELECT insert_sample_type('Serum'); 
SELECT create_relationship_panel_sampletype('APTT','Serum'); 
SELECT create_relationship_panel_test('APTT','APTT (Test)'); 
SELECT create_relationship_sample_test('Serum','APTT (Test)'); 
SELECT insert_unit_of_measure('sec','APTT (Test)'); 
SELECT create_relationship_test_section_test('Biochemistry','APTT (Test)'); 
...
SELECT create_relationship_sample_test('Sputum','Culture'); 
...
SELECT create_relationship_sample_test('Tissue','Culture'); 
SELECT insert_unit_of_measure('','Culture'); 
SELECT create_relationship_test_section_test('Microbiology','Culture'); 
SELECT add_test_result_type('Culture','R'); 
-- Begin Line: 42 
SELECT insert_test_section('Microbiology'); 
SELECT insert_sample_type('Blood (EDTA)'); 
SELECT create_relationship_sample_test('Blood (EDTA)','Culture'); 
SELECT insert_unit_of_measure('','Culture'); 
SELECT create_relationship_test_section_test('Microbiology','Culture'); 
SELECT add_test_result_type('Culture','R'); 
-- Begin Line: 43 
SELECT insert_test_section('Microbiology'); 
SELECT insert_sample_type('Semen'); 
SELECT create_relationship_sample_test('Semen','Culture'); 
SELECT insert_unit_of_measure('','Culture'); 
SELECT create_relationship_test_section_test('Microbiology','Culture'); 
SELECT add_test_result_type('Culture','R'); 
-- Begin Line: 44 
...
SELECT insert_sample_type('Body Fluid'); 
SELECT create_relationship_panel_sampletype('Pus','Body Fluid'); 
SELECT create_relationship_panel_test('Pus','Gram Stain (Pus)'); 
SELECT create_relationship_sample_test('Body Fluid','Gram Stain (Pus)'); 
SELECT insert_unit_of_measure('','Gram Stain (Pus)'); 
...
SELECT create_relationship_panel_sampletype('Serology','Serum'); 
SELECT create_relationship_panel_test('Serology','HIV ELISA'); 
SELECT create_relationship_sample_test('Serum','HIV ELISA'); 
SELECT insert_unit_of_measure('NA','HIV ELISA'); 
SELECT create_relationship_test_section_test('Serology','HIV ELISA'); 
SELECT add_test_result_type('HIV ELISA','D', 'Positive'); 
SELECT add_test_result_type('HIV ELISA','D', 'Negative'); 
...
SELECT create_relationship_panel_test('Prothrombin Time','INR Ratio'); 
SELECT create_relationship_sample_test('Serum','INR Ratio'); 
SELECT insert_unit_of_measure('ratio','INR Ratio'); 
SELECT create_relationship_test_section_test('Biochemistry','INR Ratio'); 
SELECT insert_result_limit_normal_range('INR Ratio',0.90,1.10); 
SELECT insert_result_limit_valid_range('INR Ratio',0.50,12); 
-- Begin Line: 125 
SELECT insert_test_section('Biochemistry'); 
...
SELECT insert_sample_type('Serum'); 
SELECT create_relationship_panel_sampletype('Prothrombin Time','Serum'); 
SELECT create_relationship_panel_test('Prothrombin Time','Prothrombin Time (Control)'); 
SELECT create_relationship_sample_test('Serum','Prothrombin Time (Control)'); 
SELECT insert_unit_of_measure('sec','Prothrombin Time (Control)'); 
SELECT create_relationship_test_section_test('Biochemistry','Prothrombin Time (Control)'); 
SELECT insert_result_limit_normal_range('Prothrombin Time (Control)',11,16); 
SELECT insert_result_limit_valid_range('Prothrombin Time (Control)',5,720); 
-- Begin Line: 182 
SELECT insert_test_section('Clinical Pathology'); 
...
SELECT insert_sample_type('Serum'); 
SELECT create_relationship_panel_sampletype('Prothrombin Time','Serum'); 
SELECT create_relationship_panel_test('Prothrombin Time','Prothrombin Time (Test)'); 
SELECT create_relationship_sample_test('Serum','Prothrombin Time (Test)'); 
SELECT insert_unit_of_measure('sec','Prothrombin Time (Test)'); 
SELECT create_relationship_test_section_test('Biochemistry','Prothrombin Time (Test)'); 
SELECT insert_result_limit_normal_range('Prothrombin Time (Test)',11,16); 
SELECT insert_result_limit_valid_range('Prothrombin Time (Test)',5,720); 
-- Begin Line: 185 
SELECT insert_test_section('Haematology'); 
...
SELECT insert_test_section('Microbiology'); 
SELECT insert_sample_type('Stool'); 
SELECT create_relationship_sample_test('Stool','Routine Microbiology Culture'); 
SELECT insert_unit_of_measure('','Routine Microbiology Culture'); 
SELECT create_relationship_test_section_test('Microbiology','Routine Microbiology Culture'); 
SELECT add_test_result_type('Routine Microbiology Culture','R'); 
-- Begin Line: 210 
SELECT insert_test_section('Microbiology'); 
SELECT insert_sample_type('Urine'); 
SELECT create_relationship_sample_test('Urine','Routine Microbiology Culture'); 
SELECT insert_unit_of_measure('','Routine Microbiology Culture'); 
SELECT create_relationship_test_section_test('Microbiology','Routine Microbiology Culture'); 
SELECT add_test_result_type('Routine Microbiology Culture','R'); 
-- Begin Line: 211 
...
SELECT insert_sample_type('Body Fluid'); 
SELECT create_relationship_panel_sampletype('Pus','Body Fluid'); 
SELECT create_relationship_panel_test('Pus','ZN Stain (Pus)'); 
SELECT create_relationship_sample_test('Body Fluid','ZN Stain (Pus)'); 
SELECT insert_unit_of_measure('','ZN Stain (Pus)'); 
