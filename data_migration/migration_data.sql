...
SELECT create_relationship_panel_test('Bio Chemistry','AFP'); 
...
SELECT add_test_result_type('MCHC','R'); 
-- Begin Line: 120 
SELECT insert_test_section('Haematology'); 
SELECT insert_sample_type('Blood (EDTA)'); 
SELECT create_relationship_panel_sampletype('Anaemia Panel','Blood (EDTA)'); 
...
SELECT insert_sample_type('Stool'); 
SELECT create_relationship_panel_sampletype('Stool Microscopy w/o Concetration','Stool'); 
SELECT create_relationship_panel_test('Stool Microscopy w/o Concetration','Others (Stool)'); 
SELECT create_relationship_sample_test('Stool','Others (Stool)'); 
SELECT insert_unit_of_measure('NA','Others (Stool)'); 
SELECT create_relationship_test_section_test('Stool','Others (Stool)'); 
SELECT add_test_result_type('Others (Stool)','R'); 
-- Begin Line: 128 
SELECT insert_test_section('Stool'); 
SELECT insert_sample_type('Stool'); 
SELECT create_relationship_panel_sampletype('Stool Microscopy with Concetration','Stool'); 
SELECT create_relationship_panel_test('Stool Microscopy with Concetration','Others (Stool)'); 
SELECT create_relationship_sample_test('Stool','Others (Stool)'); 
SELECT insert_unit_of_measure('NA','Others (Stool)'); 
SELECT create_relationship_test_section_test('Stool','Others (Stool)'); 
SELECT add_test_result_type('Others (Stool)','R'); 
...
SELECT add_test_result_type('Pus Cells (Urine)','R'); 
-- Begin Line: 166 
SELECT insert_test_section('Stool'); 
SELECT insert_sample_type('Stool'); 
SELECT create_relationship_panel_sampletype('Stool Microscopy w/o Concetration','Stool'); 
